...
| **Quarto, octavo, French fold, source cropping** | Not built. See [the gap analysis](docs/research/2026-08-05-competitive-gaps.md) for what is worth building and in what order. |
