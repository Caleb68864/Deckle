...
| 14 | `plan_passes` reads only `Sheet.index` (REQ-035) | [MECHANICAL] | `python -m pytest tests/test_spec_residue.py -q -k reads_only_sheet_index \|\| (echo "FAIL: plan_passes touches a Sheet attribute other than index" && exit 1)` |
